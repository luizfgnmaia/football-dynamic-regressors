...
+ `scoring_rules.R` and `scoring_rules_draw.R` generates Figure 7 and Tables 9 and 10.
...
`future.apply` (1.20.0), `progress` (1.2.3), `CVXR` (1.0.15), `Rmosek` (9.3.2), `fastDummies` (1.7.5).
